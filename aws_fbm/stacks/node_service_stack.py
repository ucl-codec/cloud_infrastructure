...
class NodeServiceStack(Stack):
    ...
    def __init__(self, scope: Construct,
        ...
        self.gui_service = HttpService(
            ...
            public_zone=node_stack.public_hosted_zone,
            cpu=4096,
            ...
            task_name="gui",
            container_port=8484,
            listener_port=443 if node_stack.use_https else 80,
            use_https=node_stack.use_https,
            redirect_http=node_stack.use_https,
            idle_timeout=1800,
            environment={
                "MQTT_BROKER": mqtt_broker,
                "MQTT_BROKER_PORT": f"{mqtt_port}",
